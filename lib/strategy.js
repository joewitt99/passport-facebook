 ...
 * @access protected
 */
Strategy.prototype.userProfile = function(accessToken, oauthObj, done) {
  ...
  if (this._enableProof) {
    ...
    var proof = crypto.createHmac('sha256', oauthObj._clientSecret).update(accessToken).digest('hex');
  ...
  oauthObj.get(url, accessToken, function (err, body, res) {
    var json;
